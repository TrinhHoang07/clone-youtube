    ...
    return (
        <ClickAwayListener onClickAway={close}>
            <Zoom in={open} timeout={300}>
                <div className="profile" style={{ backgroundColor: leftColor }}>
                    <List>
                    ...
                    <Divider />
                    <List>
                        <Link to="/yourchannel/featured" style={{ textDecoration: 'none' }}>
                            <ListItemButton sx={{ ":hover": { backgroundColor: colorHover }, padding: '6px 16px', color: color }}>
                                <ListItemIcon>
                                    <AccountBoxOutlinedIcon sx={{ fontSize: 26, color: color }} />
                                </ListItemIcon>
                                <ListItemText
                                    className="app-text"
                                    primary="Kênh của bạn"
                                />
                            </ListItemButton>
                        </Link>
                        <ListItemButton sx={{ ":hover": { backgroundColor: colorHover }, padding: '6px 16px', color: color }}>
                            <ListItemIcon>
                                <MonetizationOnOutlinedIcon sx={{ fontSize: 26, color: color }} />
                            </ListItemIcon>
                            <ListItemText
                                className="app-text"
                                primary="Giao dịch mua và gói thành viên"
                            />
                        </ListItemButton>
                        <ListItemButton sx={{ ":hover": { backgroundColor: colorHover }, padding: '6px 16px', color: color }}>
                            <ListItemIcon>
                        ...
                        <ListItemButton sx={{ ":hover": { backgroundColor: colorHover }, padding: '6px 16px', color: color }}>
                            <ListItemIcon>
                                <GroupAddOutlinedIcon sx={{ fontSize: 26, color: color }} />
                            </ListItemIcon>
                            <ListItemText
                                className="app-text"
